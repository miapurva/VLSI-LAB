...
HD_PWD='/home/SDx/2016.4/Vivado/bin/project_new/project_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pe_cu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pe_cu.tcl -notrace
